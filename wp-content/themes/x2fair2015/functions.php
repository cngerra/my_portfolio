<?php
//Register Custom Bootstrap Navigation
require_once(TEMPLATEPATH . '/wp_bootstrap_navwalker.php');
...
function toolbox_setup() {
	...
	register_nav_menu( 'footer', __( 'Footer Menu', 'toolbox' ) );
...
function get_specific_content($post_id){
