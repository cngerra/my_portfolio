        ...
        <tbody>
                ...
                <td>
                    ...
                    <select name="wl-gallery-layout" id="wl-gallery-layout">
                        ...
                        <optgroup label="Select Gallery Layout">
                            ...
                            <option value="col-md-3" <?php if($WL_Gallery_Layout == 'col-md-3') echo "selected=selected"; ?>><?php _e("Four Column", WEBLIZAR_RPG_TEXT_DOMAIN); ?></option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="radio" name="wl-image-view-icon" id="wl-image-view-icon" value="vancmochi-icon" <?php if($WL_Image_View_Icon == 'vancmochi-icon' ) { echo "checked"; } ?>> <img src="<?php echo plugins_url();?>/responsive-photo-gallery/images/vanmochi.png" />
