...
$paramssld["ht_view9_general_content_count"] = "5";
		...
		<div class="element_<?php echo $galleryID; ?> col-xs-12 col-sm-6 col-md-3" tabindex="0" data-symbol="<?php echo $row->name; ?>" data-category="alkaline-earth">
			...
			<div class="title-block_<?php echo $galleryID; ?>">
				...
				<?php if($paramssld["ht_view2_element_show_linkbutton"]=='on'){?>
					...
					<div class="button-block"><a href="javascript:void(0)">Enquire about this Product</a></div>
				<?php } ?>
			</div>
		</div>	
		<?php
